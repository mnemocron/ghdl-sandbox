...
ghdl -a ../dds.vhd
ghdl -a ../polyphase_dds/polyphase_dds.vhd
ghdl -a axis_m_polyphase_dds.vhd
...
ghdl -e axis_m_polyphase_dds

# run
#ghdl -r tb_axis_m_polyphase_dds --vcd=wave.vcd --stop-time=1us
